...
function init() {
	...
	var comp=AdobeAn.getComposition("A3F939C94E1A47F1A0B9E730F324AEEA");
...
function handleComplete(evt,comp) {
	...
	exportRoot = new lib.SAHSpringAnimation();
...
(function (cjs, an) {
	...
	lib.properties = {
		...
		opacity: 1.00,
		manifest: [
			{src:"/themes/swedishamerican/images/Artboard1100.jpg", id:"Artboard1100"}
		],
		preloads: []
	};
